              ...
              <Row>
                <Col>
                  <div className={Style.box}>
                    ...
                    <p>
                      Committed to delivering compassionate pediatric
                      healthcare, advanced diagnostics, and trusted medical
                      services with excellence for over 25+ years.
                    </p>
                  </div>
                </Col>
              </Row>
            ...
            <Row>
              <Col md={6} className={Style.fullWid}>
                <div className={Style.content}>
                  <h2>Who We Are</h2>
                  <p>
                    Established with the vision of delivering quality pediatric
                    healthcare under one roof, Namokar Hospital & Diagnostic
                    Centre has become a trusted name for child healthcare
                    services in Deoli.
                  </p>
                  <p>
                    Our hospital offers preventive healthcare, advanced
                    diagnostics, emergency treatment, vaccination programs,
                    asthma management, and newborn care. Every patient is
                    treated with compassion, respect, and personalized
                    attention.
                  </p>
                  <ul>
                    <li>
                      ...
                      Expert pediatric care for every stage of childhood
                    </li>
                    <li>
                      <span className={Style.icon}>
                        <FaCheckCircle />
                      </span>
                      Advanced diagnostics with modern technology
                    </li>
                    <li>
                      <span className={Style.icon}>
                        <FaCheckCircle />
                ...
                <div className={Style.missionContainer}>
                  <div className={Style.box}>
                    <div className={Style.content}>
                      ...
                      <p>
                        ...
                        healthcare with compassion, integrity, and clinical
                        excellence while improving the health and well-being of
                  ...
                  <div className={Style.box}>
                    <div className={Style.content}>
                      ...
                      <p>
                        To become the most trusted pediatric healthcare and
                        diagnostic center by delivering world-class medical
                        services through innovation, expertise, and
                ...
                <div className={Style.content}>
                  ...
                  <ul>
                    <li>
                      ...
                      <p>
                        Healthcare services specially designed for infants,
                    ...
                    <li>
                      ...
                      <p>
                        Qualified pediatricians and healthcare professionals
                    ...
                    <li>
                      ...
                      <p>
                        Modern laboratory and diagnostic equipment for accurate
                        and timely results.
                      </p>
                    </li>
                    <li>
                      ...
                      <p>
                        Immediate medical attention available around the clock.
                      </p>
                    </li>
                    <li>
                      <div className={Style.icon}>
                      ...
                      <p>
                        From preventive care to treatment and follow-up,
